...
class Musics {
    ...
    constructor() {
        this.songs = [{
                ...
                title: '湫兮如风',
                singer: '徐佳莹',
                songUrl: './songs/徐佳莹 - 湫兮如风.mp3',
                imageUrl: './images/songs/p1.jpg'
            },
            {
                id: 2,
                title: '香奈儿',
                singer: '王菲',
                songUrl: './songs/香奈儿 - 王菲.mp3',
                imageUrl: './images/songs/p2.jpg'
            },
            {
                id: 3,
                title: '如是说',
                singer: '夏小桐',
                songUrl: './songs/夏小桐 - 如是说.mp3',
                imageUrl: './images/songs/p3.jpg'
            },
            {
                id: 4,
                title: '我想',
                singer: '麦小兜',
                songUrl: './songs/我想 - 麦小兜.mp3',
                imageUrl: './images/songs/p4.jpg'
            },
            {
                id: 5,
                title: '想你，零点零一分',
                singer: '张靓颖',
                songUrl: './songs/想你，零点零一分 - 张靓颖.mp3',
                imageUrl: './images/songs/p5.jpg'
            },
            {
                id: 6,
                title: '小手拉大手',
                singer: '梁静茹',
                songUrl: './songs/小手拉大手 - 梁静茹.mp3',
                imageUrl: './images/songs/p6.jpg'
            },
            {
                id: 7,
                title: '荒岛',
                singer: '谢春花',
                songUrl: './songs/谢春花 - 荒岛.mp3',
                imageUrl: './images/songs/p7.jpg'
            },
            {
                id: 8,
                title: '幸福的节拍',
                singer: '杨丞琳',
                songUrl: './songs/幸福的节拍 - 杨丞琳.mp3',
                imageUrl: './images/songs/p8.jpg'
            },
            {
                id: 9,
                title: '風の記憶 (风的记忆)',
                singer: '熊木杏里 (Anri Kumaki)',
                songUrl: './songs/熊木杏里 (Anri Kumaki) - 風の記憶 (风的记忆).mp3',
                imageUrl: './images/songs/p9.jpg'
            },
            {
                id: 10,
                title: '红昭愿',
                singer: '音阙诗听',
                songUrl: './songs/音阙诗听+-+红昭愿.mp3',
                imageUrl: './images/songs/p10.jpg'
            },
            {
                id: 11,
                title: 'Burning Bright',
                singer: '英雄联盟',
                songUrl: './songs/英雄联盟 - Burning Bright.mp3',
                imageUrl: './images/songs/p11.jpg'
            },
            {
                id: 12,
                title: '有你真好',
                singer: '范玮琪,杨丞琳',
                songUrl: './songs/有你真好 - 范玮琪,杨丞琳.mp3',
                imageUrl: './images/songs/p12.jpg'
            },
            {
                id: 13,
                title: '遇见',
                singer: '孙燕姿',
                songUrl: './songs/遇见 - 孙燕姿.mp3',
                imageUrl: './images/songs/p13.jpg'
            },
            {
                id: 14,
                title: '曾经我也想过一了百了',
                singer: '芝麻mochi',
                songUrl: './songs/芝麻mochi - 僕が死のうと思ったのは (曾经我也想过一了百了).mp3',
                imageUrl: './images/songs/p14.jpg'
            }
        ]
    }
    //根据索引获取歌曲的方法
